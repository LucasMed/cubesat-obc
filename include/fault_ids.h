...
extern "C"
{
  ...
  #define FAULT_EST_QUAT_NORM                                                                      \
    (FAULT_SUBSYS_ESTIMATOR | 0x04u) /**< Quaternion norm out of range                             \
                                      */
  ...
  #define FAULT_EPS_VBATT_LOW                                                                      \
    (FAULT_SUBSYS_EPS | 0x01u) /**< Battery voltage below LOW threshold                            \
                                */
