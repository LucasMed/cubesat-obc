...
/**
 * UART1 (optional, for future expansion/secondary comms)
 * RP2040 UART1: GPIO4 (TX), GPIO5 (RX)
 * Note: Shares pins with I2C0, select one at a time
 */
